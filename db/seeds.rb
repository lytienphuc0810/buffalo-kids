...
book_reserve1 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 1, :receive => false)
book_reserve2 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 2, :receive => false)
book_reserve3 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 3, :receive => false)
book_reserve4 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 4, :receive => false)
book_reserve5 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 5, :receive => false)
book_reserve6 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 6, :receive => false)
book_reserve7 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 7, :receive => false)
book_reserve8 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 8, :receive => false)
book_reserve9 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 9, :receive => false)
book_reserve10 = BookReservation.create(:start_date => Date.today, :due_date => Date.today + 10, :receive => false)
